...
, (select id from "CREDIT_PACKAGE" where name = '14 堂組合方案包')
, (select credit_amount from "CREDIT_PACKAGE" where name = '14 堂組合方案包')
, (select price from "CREDIT_PACKAGE" where name = '14 堂組合方案包')
)
,(
(select id from "USER" where name = '王小明')
, (select id from "CREDIT_PACKAGE" where name = '21 堂組合方案包')
, (select credit_amount from "CREDIT_PACKAGE" where name = '21 堂組合方案包')
, (select price from "CREDIT_PACKAGE" where name = '21 堂組合方案包')
)
,(
...
values (
(select c.user_id from "COACH" c where c.user_id = (select id from "USER" where email = 'lee2000@hexschooltest.io')), 
